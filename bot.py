...
TEXTS = {
    "uz": {
        ...
        "about_text": "🤖 LSB steganografiya boti — rasmga matn yashiradi va chiqaradi. ⚡ NumPy bilan tez ishlaydi.\n👨‍💻 Dasturchi: @Fuzzsss",
    ...
    "ru": {
        ...
        "about_text": "🤖 Бот стеганографии LSB — скрывает и извлекает текст из изображений. ⚡ Быстро работает благодаря NumPy.\n👨‍💻 Разработчик: @Fuzzsss",
    ...
    "en": {
        ...
        "about_text": "🤖 LSB steganography bot — hides and extracts text from images. ⚡ Fast thanks to NumPy.\n👨‍💻 Developer: @Fuzzsss",
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == CB_HIDE or data == CB_HIDE_AGAIN:
        ...
        await safe_edit(query, t(user_id, "about_text"), reply_markup=back_keyboard(user_id))
...
def main():
    ...
    logger.info("🤖 Bot ishga tushdi (admin_id=%s)...", ADMIN_ID)
