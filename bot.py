...
async def send_final_result(user_id: int, chat_id: int, context: ContextTypes.DEFAULT_TYPE, filename: str):
    ...
    if data is None:
        await context.bot.send_message(chat_id=chat_id, text=t(user_id, "no_image_found"), reply_markup=main_menu_keyboard(user_id))
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == CB_HIDE or data == CB_HIDE_AGAIN:
        ...
        await safe_edit(query, t(user_id, "ask_filename_text"))
