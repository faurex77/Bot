...
def buy(message):
    ...
    msg = bot.send_message(message.chat.id, "📥 Qanday akkaunt kerak?")
...
def save_buy(message):
    ...
    bot.send_message(MAIN_ADMIN, f"📥 YANGI BUY:\n{message.text}")
...
❗ Screenshot talab qilinishi mumkin
""")


# =====================
# PHOTO ROUTER (SELL + PAYMENT)
# =====================
